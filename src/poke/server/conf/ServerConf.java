...
private NetworkConf networkStructure;
...
public void addNodes(NetworkNodeDesc node) {
if (networkStructure == null)
networkStructure = new NetworkConf();

networkStructure.add(node);
}

public NetworkConf getNetworkStructure() {
return networkStructure;
}

public void setNetworkStructure(NetworkConf networkConf) {
// TODO should be a deep copy
this.networkStructure = networkConf;
}
...
@XmlRootElement(name = "networkStructure")
@XmlAccessorType(XmlAccessType.FIELD)
public static final class NetworkConf {
private TreeMap<String, NetworkNodeDesc> networkStruct;

public NetworkNodeDesc getNode(String name) {
return networkStruct.get(name);
}

public void add(NetworkNodeDesc node) {
if (node == null)
return;
else if (networkStruct == null)
networkStruct = new TreeMap<String, NetworkNodeDesc>();

networkStruct.put(node.getNodeId(), node);
}

public TreeMap<String, NetworkNodeDesc> getNodes() {
return networkStruct;
}

public void setNodes(TreeMap<String, NetworkNodeDesc> networkStruct) {
